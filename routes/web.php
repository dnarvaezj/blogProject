...
Route::post('/admin/categories/{categoryId}/delete', [App\Http\Controllers\Admin\CategoriesController::class, 'delete'])->name('admin.categories.delete');

Route::get('/category', 'App\Http\Controllers\CategoriesController@index');
